...
declare module 'lodash/fp' {
  ...
  declare class Lodash {
    ...
    includesFrom<T>(
      value: T
    ): ((fromIndex: number) => (collection: Array<T>) => boolean) & ((fromIndex: number, collection: Array<T>) => boolean);
    ...
    getOr(
      defaultValue: any
    ): ((path: Path) => (object: Object | Array<any>) => any) & ((path: Path, object: Object | $ReadOnlyArray<any> | void | null) => any);
