...
declare module 'apollo-client' {
  ...
  declare export class ObservableQuery<T> extends Observable<ApolloQueryResult<T>> {
    ...
    fetchMore(fetchMoreOptions: FetchMoreQueryOptions<any> & FetchMoreOptions<any, any>): Promise<ApolloQueryResult<T>>;
  ...
  declare class QueryStore {
    ...
    markQueryResult(queryId: string, result: ExecutionResult<>, fetchMoreForQueryId: string | void): void;
  ...
  declare class QueryScheduler<TCacheShape> {
    ...
    fetchQuery<T>(queryId: string, options: WatchQueryOptions, fetchType: FetchType): Promise<FetchResult<T>>;
  ...
  declare export interface MutationOptions<T = { [key: string]: any, ... }> extends MutationBaseOptions<T> {
  ...
  declare export type FetchPolicy = 'cache-first' | 'cache-and-network' | 'network-only' | 'cache-only' | 'no-cache' | 'standby';
  ...
  declare export type MutationUpdaterFn<T = OperationVariables> = (proxy: DataProxy, mutationResult: FetchResult<T>) => void;
  ...
  declare export type FetchResult<C = { [key: string]: any, ... }, E = { [key: string]: any, ... }> = ExecutionResult<C> & {
    extension?: E,
    context?: C,
    ...
  };
  ...
  declare type RequestHandler = (operation: Operation, forward?: NextLink) => Observable<FetchResult<>> | null;
  ...
  declare class Observable<T> {
    ...
    reduce<R>(fn: (previousValue: R | T, currentValue: T) => R | T, initialValue?: R | T): Observable<R | T>;
  ...
  declare type ZenObservableSubscriber<T> = (observer: ZenObservableSubscriptionObserver<T>) => void | (() => void) | SubscriptionLINK;
  ...
  declare export class ApolloCache<TSerialized> {
    ...
    readQuery<QueryType>(options: DataProxyReadQueryOptions, optimistic?: boolean): QueryType | null;
